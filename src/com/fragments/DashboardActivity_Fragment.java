...
import com.example.sampleactionbar.BaseMapActivity;
...
public class DashboardActivity_Fragment extends Fragment{
	...
	public DashboardActivity_Fragment() {
		super();
	}
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		...
		mainV = inflater.inflate(R.layout.dashboard, container, false);
		
		DashboardActivity_Fragment.inflater = inflater; 
		
		table_lay = (TableLayout)mainV.findViewById(R.id.table_lay);
	...
	class DashboardLoadTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			if(Utils.testNetwork(getActivity())){
...
//						showDisabledSectionOffline("Customize");
		...
		View getAttractionWidget(final String localyticsLog){
			...
			final ViewFlipper flipperDinner = new ViewFlipper(getActivity());
			...
			flipperDinner.setInAnimation(getActivity(),android.R.anim.fade_in);
			flipperDinner.setOutAnimation(getActivity(), android.R.anim.fade_out);
	...
	public void loadMetroView() {
		//loading metro view here
		   ...
		   RelativeLayout rel_img_news = (RelativeLayout)mainV.findViewById(R.id.rel_img_news);
			...
			View mv = inflater.inflate(R.layout.tile_metro_view, null);
